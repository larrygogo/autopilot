...
```python
from dev_workflow.state_machine import get_available_triggers

triggers = get_available_triggers(task_id)
# 返回如：[('start_design', 'designing'), ('cancel', 'cancelled')]
```

### 检查转换合法性

```python
from dev_workflow.state_machine import can_transition
