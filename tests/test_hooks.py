...
from core.registry import register, _registry, validate_workflow
...
def _create_test_task(task_id: str = 'hook_test_1', workflow: str = 'test_hooks_wf',
                      status: str = 'pending_step1') -> None:
    create_task(
        task_id=task_id,
        req_id='REQ-HOOK',
        title='Hook Test',
...
class TestExecutePhaseWithHooks:
    ...
    def test_all_hooks_called_on_success(self):
        ...
        try:
            ...
            with mock.patch('core.runner.acquire_lock', return_value=mock.Mock()), \
