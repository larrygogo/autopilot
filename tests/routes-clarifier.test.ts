...
import { createSpecRevision } from "../src/core/requirements/spec-revisions";
...
function initSchema(): void {
  ...
  [m001, m002, m004, m005, m006, m007, m008, m009, m010, m011, m012, m013, m014, m021, m024, m032, m034].forEach(fn => fn(db));
  _setDbForTest(db);
