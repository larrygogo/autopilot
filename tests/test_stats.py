...
"""
import json
from core.db import create_task, list_tasks, get_task_stats, get_conn, now


def _create_sample_task(task_id: str, workflow: str = 'dev', status: str = 'pending_design',
                        project: str = 'proj1') -> None:
    """创建样本任务"""
    create_task(
        task_id=task_id,
