...
from core.infra import PROJECTS_DIR, _run_git, get_task_dir, run_claude
...
WORKFLOW = {
    ...
    "transitions": {
        ...
        "reviewing": [("review_pass", "developing"), ("review_reject", "review_rejected"), ("cancel", "cancelled")],
        "review_rejected": [("retry_design", "pending_design"), ("cancel", "cancelled")],
        "developing": [("start_dev", "in_development"), ("cancel", "cancelled")],
        "in_development": [("dev_complete", "code_reviewing"), ("dev_fail", "developing"), ("cancel", "cancelled")],
        "code_reviewing": [("code_pass", "pr_submitted"), ("code_reject", "code_rejected"), ("cancel", "cancelled")],
