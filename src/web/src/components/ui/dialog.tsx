...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm p-1 border border-transparent opacity-70 transition-all hover:opacity-100 hover:border-border focus:outline-none focus:ring-2 focus:ring-ring focus:ring-inset disabled:pointer-events-none">
          <X className="h-4 w-4" />
