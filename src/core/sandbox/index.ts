 ...
 */
/** @internal 导出供 sandbox-retention.ts 兄弟模块用（legacy 任务根遍历）。 */
 ...
 */
export function requirementsRootDir(): string {
...
/** @internal 递归目录字节数；导出供 sandbox-browse.ts / sandbox-retention.ts 兄弟模块用。 */
